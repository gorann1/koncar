...
class Drop extends React.Component {
  ...
  <div class="dropdown inline-block relative">
    ...
    <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
      <li className="">
        <Link to='/employees' class="text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300 py-2 px-4 block whitespace-no-wrap" href="{'/index}">Zaposlenih</Link></li>
